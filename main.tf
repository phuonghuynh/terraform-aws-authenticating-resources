locals {
  module_name = "iam-group-${substr(uuid(), 24, 12)}"
  ...
  clear_event_rule_name = "clear-expired-${local.module_name}"
...
/* handling logs generated by aws_api_gateway_method_settings */
